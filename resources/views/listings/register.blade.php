<x-login-card>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <header class="text-center">
            <h2 class="text-2xl font-bold uppercase mb-1">Register User</h2>
        ...
        <form method="POST" action="/register" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select class="border border-gray-200 rounded p-2 w-full" name="account_type" value="{{ old('account_type') }}">
            ...
            <div class="mb-6">
                <button class="bg-laravel text-black rounded py-2 px-4 hover:bg-white">Register</button>
